  ...
  return (
    <div className=" lg:flex py-20 lg:justify-between  w-full bg-secondary-dark px-6 sm:px-10 lg:px-[165px]">
      ...
      <Formik  initialValues={initialValues} validationSchema={validationSchema} onSubmit={handleSubmit}>
        ...
        <Field
          placeholder="NAME"
          className={`border-b text-white outline-none py-2 ${touched.name && 'border-primary-green' }  border-white bg-secondary-dark`}
          type="text"
          name="name"
        />
        ...
        <Field
          placeholder="EMAIL"
          className={`py-2 text-white outline-none mt-5 bg-secondary-dark border-b ${errors.email && touched.email ? 'border-red-500' : touched.email ? 'border-primary-green' : null} border-white `}
          type="email"
          name="email"
          id="email"
        />
       {errors.email && touched.email ? <div className="text-red-500 text-right pt-1">{errors.email}</div>: null}
        ...
        <Field
          className={` text-white ${touched.message && 'border-primary-green' } h-[107px] outline-none bg-secondary-dark border-b`}
          name="message"
          id=""
          cols="30"
          rows="10"
